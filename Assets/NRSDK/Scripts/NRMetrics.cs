    ...
    public class NRMetrics : SingletonBehaviour<NRMetrics>
    {
        ...
        internal class FrameMetrics
        {
            ...
            override public string ToString()
            {
                ...
                return string.Format("FrameMetrics: FPS={0}, frNum={1}, UpdPrd={2}, prd={3}, postPrd={4}, sdkPrd={5}, FPC={6}, EFC={7}, early={8}, drop={9}\n frNumA={10}, UpdPrdA={11}, prdA={12}, postPrdA={13}, sdkPrdA={14}, FPCA={15}, EFCA={16}, earlyA={17}, dropA={18}",
                    ...
                    m_FrameNumAll, avgUpdateToPresentTAll, avgPreToPresentTAll, avgPostToPresentTAll, avgSdkFrameLatencyAll, avrFramePresentCountAll, avgExtraFrameCountAll, sumEarlyFrameCountAll, sumDroppedFrameCountAll);
            }
