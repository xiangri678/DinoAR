...
namespace NRKernal
{
    ...
    public class NRHMDPoseTracker : MonoBehaviour
    {
        ...
        /// <param name="OnModeChanged"> The mode changed call back and return the result.</param>
        public bool ChangeTo6Dof(OnTrackingModeChanged OnModeChanged)
        {
        ...
        /// <param name="OnModeChanged"> The mode changed call back and return the result.</param>
        public bool ChangeTo3Dof(OnTrackingModeChanged OnModeChanged)
        {
        ...
        /// <param name="OnModeChanged"> The mode changed call back and return the result.</param>
        public bool ChangeTo0Dof(OnTrackingModeChanged OnModeChanged)
        {
        ...
        /// <summary> Change to 3 degree of freedom. </summary>
        /// <param name="OnModeChanged"> The mode changed call back and return the result.</param>
        public bool ChangeTo0DofStable(OnTrackingModeChanged OnModeChanged)
        {
