...
namespace NRKernal
{
    ...
    internal partial class NativeHandTracking
    {
        ...
        public void Update(HandState rightHand, HandState leftHand)
        {
            ...
            var result = NativeApi.NRAcquireHandTrackingData(PerceptionHandle, NRFrame.CurrentPoseTimeStamp, ref m_TrackingDataHandle);
            NativeErrorListener.Check(result, this, "NRAcquireHandTrackingData");
            ...
            for (int i = 0; i < hand_count; i++)
            {
                ...
                for (UInt32 j = 0; j < handJointCount; j++)
                {
                    ...
                    NativeApi.NRHandJointStateDestroy(hand_joint_state_handle);
                    NativeErrorListener.Check(result, this, "NRHandJointStateDestroy");
                }
                result = NativeApi.NRHandStateDestroy(hand_state_handle);
                NativeErrorListener.Check(result, this, "NRHandStateDestroy");
            }
        ...
        private partial struct NativeApi
        {
            ...
            [DllImport(NativeConstants.NRNativeLibrary)]
            public static extern NativeResult NRAcquireHandTrackingData(UInt64 perception_handle, UInt64 timestamp, ref UInt64 out_hand_tracking_data_handle);
