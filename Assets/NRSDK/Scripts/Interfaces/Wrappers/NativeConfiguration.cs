...
namespace NRKernal
{
    ...
    public partial class NativeConfiguration
    {
        ...
        private UInt64 Create()
        {
            ...
            var result = NativeApi.NRConfigCreate(m_NativeInterface.PerceptionHandle, ref config_handle);
        ...
        public TrackablePlaneFindingMode GetPlaneFindMode(UInt64 config_handle)
        {
            ...
            var result = NativeApi.NRConfigGetTrackablePlaneFindingMode(m_NativeInterface.PerceptionHandle, config_handle, ref mode);
        ...
        public bool SetPlaneFindMode(UInt64 config_handle, TrackablePlaneFindingMode mode)
        {
            ...
            var result = NativeApi.NRConfigSetTrackablePlaneFindingMode(m_NativeInterface.PerceptionHandle, config_handle, mode_value);
        ...
        public UInt64 GetTrackableImageDataBase(UInt64 config_handle)
        {
            ...
            var result = NativeApi.NRConfigGetTrackableImageDatabase(m_NativeInterface.PerceptionHandle, config_handle, ref database_handle);
        ...
        {
            var result = NativeApi.NRConfigSetTrackableImageDatabase(m_NativeInterface.PerceptionHandle, config_handle, database_handle);
        ...
        {
            bool enabled = false;
            if (m_NativeInterface.PerceptionHandle == 0 || m_ConfigHandle == 0)
                return false;
            var result = NativeApi.NRConfigIsTrackableAnchorEnabled(m_NativeInterface.PerceptionHandle, m_ConfigHandle, ref enabled);
            NRDebugger.Info("[NativeConfigration] IsTrackableAnchorEnabled : {0} {1} {2}", enabled, m_NativeInterface.PerceptionHandle, m_ConfigHandle);
        ...
        public bool SetTrackableAnchorEnabled(bool enabled)
        {
            if (m_NativeInterface.PerceptionHandle == 0 || m_ConfigHandle == 0)
                return false;
            NRDebugger.Info("[NativeConfigration] SetTrackableAnchorEnabled : {0} {1} {2}", enabled, m_NativeInterface.PerceptionHandle, m_ConfigHandle);
            var result = NativeApi.NRConfigSetTrackableAnchorEnabled(m_NativeInterface.PerceptionHandle, m_ConfigHandle, enabled);
        ...
        public bool IsMeshingEnabled()
        {
            ...
            if (m_NativeInterface.PerceptionHandle == 0 || m_ConfigHandle == 0)
                return false;
            var result = NativeApi.NRConfigIsMeshingEnabled(m_NativeInterface.PerceptionHandle, m_ConfigHandle, ref enabled);
            NRDebugger.Info("[NativeConfigration] IsMeshingEnabled : {0} {1} {2}", enabled, m_NativeInterface.PerceptionHandle, m_ConfigHandle);
        ...
        public bool SetMeshingEnabled(bool enabled)
        {
            if (m_NativeInterface.PerceptionHandle == 0 || m_ConfigHandle == 0)
                return false;
            NRDebugger.Info("[NativeConfigration] SetMeshingEnabled : {0} {1} {2}", enabled, m_NativeInterface.PerceptionHandle, m_ConfigHandle);
            var result = NativeApi.NRConfigSetMeshingEnabled(m_NativeInterface.PerceptionHandle, m_ConfigHandle, enabled);
        ...
        public bool IsHandTrackingEnabled()
        {
            ...
            if (m_NativeInterface.PerceptionHandle == 0 || m_ConfigHandle == 0)
                return false;
            var result = NativeApi.NRConfigIsHandTrackingEnabled(m_NativeInterface.PerceptionHandle, m_ConfigHandle, ref enabled);
            NRDebugger.Info("[NativeConfigration] IsHandTrackingEnabled : {0} {1} {2}", enabled, m_NativeInterface.PerceptionHandle, m_ConfigHandle);
        ...
        public bool SetHandTrackingEnabled(bool enabled)
        {
            if (m_NativeInterface.PerceptionHandle == 0 || m_ConfigHandle == 0)
                return false;
            var result = NativeApi.NRConfigSetHandTrackingEnabled(m_NativeInterface.PerceptionHandle, m_ConfigHandle, enabled);
            NRDebugger.Info("[NativeConfigration] SetHandTrackingEnabled : {0} {1} {2}", enabled, m_NativeInterface.PerceptionHandle, m_ConfigHandle);
        ...
        {
            var result = NativeApi.NRConfigDestroy(m_NativeInterface.PerceptionHandle, config_handle);
