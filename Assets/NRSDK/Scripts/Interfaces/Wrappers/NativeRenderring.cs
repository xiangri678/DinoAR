...
namespace NRKernal
{
    ...
    internal class NativeRenderring
    {
        ...
        public bool Create()
        {
            ...
            NativeRenderFlags colorspace = QualitySettings.activeColorSpace == ColorSpace.Linear ? NativeRenderFlags.LINEAR : NativeRenderFlags.NONE;
            NativeApi.NRRenderingInitSetFlags(m_RenderingHandle, (UInt64)colorspace);
