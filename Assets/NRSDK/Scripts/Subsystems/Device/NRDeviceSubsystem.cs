...
namespace NRKernal
{
    ...
    #region glasses over temperature
    /// <summary>
    ///  The callback method type which will be called when the temperature of the glasses is above the threshold or not.
    /// </summary>
    /// <param name="glasses_control_handle"> The handle of GlassesControl </param>
    /// <param name="status"> 0: the temperature is below the threshold 1:the temperature is above the threshold </param>
    /// <param name="user_data">The custom user data. </param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void NRGlassesControlOverTemperatureCallback(UInt64 glasses_control_handle, Int32 status, IntPtr user_data);
    public delegate void GlassesOverTemperatureEvent();
    #endregion
    ...
    public class NRDeviceSubsystem : IntegratedSubsystem<NRDeviceSubsystemDescriptor>
    {
        ...
        /// <summary> Event queue for all listeners interested in GlassesOverTemperatureEvent events. </summary>
        private static event GlassesOverTemperatureEvent OnGlassesOverTemperature;
        ...
        public override void Start()
        {
            ...
            NativeApi.NRGlassesControlSetOverTemperatureCallback(NativeGlassesHandler, OnGlassesControlOverTemperature, IntPtr.Zero);
#if USING_XR_SDK
        ...
        #region Temperature hot callback
        public void AddGlassesOverTemperatureListener(GlassesOverTemperatureEvent listener)
        {
            OnGlassesOverTemperature += listener;
        }
        public void RemoveGlassesOverTemperatureListener(GlassesOverTemperatureEvent listener)
        {
            OnGlassesOverTemperature -= listener;
        }

        [MonoPInvokeCallback(typeof(NRGlassesControlOverTemperatureCallback))]
        private static void OnGlassesControlOverTemperature(UInt64 glasses_control_handle, Int32 status, IntPtr user_data)
        {
            if (status > 0)
            {
                OnGlassesOverTemperature?.Invoke();
            }
        }
        #endregion
        ...
        private struct NativeApi
        {
            ...
            /// <summary>
            /// Set the callback method of over temperature
            /// </summary>
            /// <param name="glasses_control_handle"> The handle of glasses control object </param>
            /// <param name="data_callback"> The callback function </param>
            /// <param name="user_data"> The data which will be returned when callback is triggered. </param>
            /// <returns></returns>
            [DllImport(NativeConstants.NRNativeLibrary, CallingConvention = CallingConvention.Cdecl)]
            public static extern NativeResult NRGlassesControlSetOverTemperatureCallback(UInt64 glasses_control_handle, NRGlassesControlOverTemperatureCallback data_callback, IntPtr user_data);
        }
    }
}