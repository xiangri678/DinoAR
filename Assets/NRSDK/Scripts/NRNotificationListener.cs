...
namespace NRKernal
{
    ...
    public class NRNotificationListener : MonoBehaviour
    {
        ...
        public class TemperatureLevelNotification : Notification
        {
            ...
            public override NRNotificationType NotificationType => NRNotificationType.TemperatureLevel;
            /// <summary> Constructor. </summary>
            /// <param name="listener"> The listener.</param>
        ...
        /// <summary> A temperature too hot notification. </summary>
        public class OverShutDownTemperatureNotification : Notification
        {
            public override NRNotificationType NotificationType => NRNotificationType.OverShutDownTemperature;
            private delegate void NRGlassesControlOverTemperatureCallback(UInt64 glasses_control_handle, Int32 status, IntPtr user_data);
            public OverShutDownTemperatureNotification(NRNotificationListener listener) : base(listener)
            {
                NRDevice.Subsystem.AddGlassesOverTemperatureListener(OnGlassesControlOverTemperature);
            }

            private void OnGlassesControlOverTemperature()
            {
                MainThreadDispather.QueueOnMainThread(() =>
                {
                    NRDebugger.Info("[OverShutDownTemperatureNotification] OnGlassesControlOverTemperature.");
                    this.Trigger(Level.High);
                });
            }
        }
        ...
        /// <summary> True to enable, false to disable the over temperature tips. </summary>
        [Header("Whether to open the over temperature prompt")]
        public bool EnableOverShutdownTempTips;
        public NRNotificationWindow OverShutdownTempPrefab;
        ...
        void Awake()
        {
            ...
            OverShutdownTempPrefab.gameObject.SetActive(false);
        }
        ...
        protected virtual void RegistNotification()
        {
            ...
            if (EnableOverShutdownTempTips) BindNotificationWindow(new OverShutDownTemperatureNotification(this), OverShutdownTempPrefab);
        }
