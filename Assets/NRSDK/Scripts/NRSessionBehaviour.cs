...
#endif
            Debug.LogFormat("[SessionBehaviour] Awake CreateSession: logLevel={0} => {1}, isXR={2}, multiThread={3}", LogLevel, NRDebugger.logLevel, NRFrame.IsXR, SessionConfig.UseMultiThread);
